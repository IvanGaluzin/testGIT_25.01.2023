...
## Взаимодействие с удаленым репозиторием
  ...
  > Загрузить локальный репозиторий новой версии на удаленый
    
    git pull origin (Название ветки)
   > Загрузить изменения с удаленого репозитория



![<Скриншот request >](/5.png)
![<Скриншот request >](/6.png)
![<Скриншот request >](/7.png)
